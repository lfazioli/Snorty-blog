...
import { n as require_browser_external_crypto, r as require_browser_external_util, t as require_browser_external_stream } from "./browser-external_stream-mcbhJVmG.js";
...
var require_arrayParser = /* @__PURE__ */ __commonJS({ "node_modules/pg-types/lib/arrayParser.js": ((exports, module) => {
...
var require_postgres_date = /* @__PURE__ */ __commonJS({ "node_modules/postgres-date/index.js": ((exports, module) => {
...
var require_mutable = /* @__PURE__ */ __commonJS({ "node_modules/xtend/mutable.js": ((exports, module) => {
...
var require_postgres_interval = /* @__PURE__ */ __commonJS({ "node_modules/postgres-interval/index.js": ((exports, module) => {
...
var require_textParsers = /* @__PURE__ */ __commonJS({ "node_modules/pg-types/lib/textParsers.js": ((exports, module) => {
...
var require_pg_int8 = /* @__PURE__ */ __commonJS({ "node_modules/pg-int8/index.js": ((exports, module) => {
	var BASE = 1e6;
...
var require_binaryParsers = /* @__PURE__ */ __commonJS({ "node_modules/pg-types/lib/binaryParsers.js": ((exports, module) => {
...
var require_builtins = /* @__PURE__ */ __commonJS({ "node_modules/pg-types/lib/builtins.js": ((exports, module) => {
	/**
...
var require_pg_types = /* @__PURE__ */ __commonJS({ "node_modules/pg-types/index.js": ((exports) => {
...
var require_types = /* @__PURE__ */ __commonJS({ "browser-external:util/types": ((exports, module) => {
	module.exports = Object.create(new Proxy({}, { get(_, key) {
		if (key !== "__esModule" && key !== "__proto__" && key !== "constructor" && key !== "splice") console.warn(`Module "util/types" has been externalized for browser compatibility. Cannot access "util/types.${key}" in client code. See http://vite.dev/guide/troubleshooting.html#module-externalized-for-browser-compatibility for more details.`);
	} }));
}) });

//#endregion
//#region node_modules/pg/lib/utils.js
var require_utils$1 = /* @__PURE__ */ __commonJS({ "node_modules/pg/lib/utils.js": ((exports, module) => {
	var defaults$4 = require_defaults();
	...
	var prepareValue = function(val$1, seen) {
		if (val$1 == null) return null;
		if (typeof val$1 === "object") {
			if (val$1 instanceof Buffer) return val$1;
			if (ArrayBuffer.isView(val$1)) return Buffer.from(val$1.buffer, val$1.byteOffset, val$1.byteLength);
	...
	var escapeIdentifier$2 = function(str) {
		return "\"" + str.replace(/"/g, "\"\"") + "\"";
	};
	var escapeLiteral$2 = function(str) {
...
var require_utils = /* @__PURE__ */ __commonJS({ "node_modules/pg/lib/crypto/utils.js": ((exports, module) => {
...
var require_cert_signatures = /* @__PURE__ */ __commonJS({ "node_modules/pg/lib/crypto/cert-signatures.js": ((exports, module) => {
...
var require_sasl = /* @__PURE__ */ __commonJS({ "node_modules/pg/lib/crypto/sasl.js": ((exports, module) => {
	var crypto$1 = require_utils();
	var { signatureAlgorithmHashFromCertificate } = require_cert_signatures();
	function saslprep(password$1) {
		return password$1.replace(/[\u00A0\u1680\u2000-\u200B\u202F\u205F\u3000]/g, " ").replace(/[\u00AD\u034F\u1806\u180B\u180C\u180D\u200C\u200D\u2060\uFE00-\uFE0F\uFEFF]/g, "").normalize("NFKC");
	}
	var DEFAULT_MAX_SCRAM_ITERATIONS = 1e5;
	function startSession(mechanisms, stream$1, scramMaxIterations = DEFAULT_MAX_SCRAM_ITERATIONS) {
		const candidates = ["SCRAM-SHA-256"];
		if (stream$1) candidates.unshift("SCRAM-SHA-256-PLUS");
		const mechanism = candidates.find((candidate) => mechanisms.includes(candidate));
		if (!mechanism) throw new Error("SASL: Only mechanism(s) " + candidates.join(" and ") + " are supported");
		if (mechanism === "SCRAM-SHA-256-PLUS" && typeof stream$1.getPeerCertificate !== "function") throw new Error("SASL: Mechanism SCRAM-SHA-256-PLUS requires a certificate");
		const clientNonce = crypto$1.randomBytes(18).toString("base64");
		return {
			mechanism,
			clientNonce,
			response: (mechanism === "SCRAM-SHA-256-PLUS" ? "p=tls-server-end-point" : stream$1 ? "y" : "n") + ",,n=*,r=" + clientNonce,
			message: "SASLInitialResponse",
			scramMaxIterations
		};
	}
	async function continueSession(session, password$1, serverData, stream$1) {
		...
		let channelBinding = stream$1 ? "eSws" : "biws";
		if (session.mechanism === "SCRAM-SHA-256-PLUS") {
			const peerCert = stream$1.getPeerCertificate().raw;
		...
		const saltedPassword = await crypto$1.deriveKey(saslprep(password$1), saltBytes, sv.iteration);
...
var require_type_overrides = /* @__PURE__ */ __commonJS({ "node_modules/pg/lib/type-overrides.js": ((exports, module) => {
	var types$2 = require_pg_types();
...
var require_browser_external_dns = /* @__PURE__ */ __commonJS({ "browser-external:dns": ((exports, module) => {
	module.exports = Object.create(new Proxy({}, { get(_, key) {
		if (key !== "__esModule" && key !== "__proto__" && key !== "constructor" && key !== "splice") console.warn(`Module "dns" has been externalized for browser compatibility. Cannot access "dns.${key}" in client code. See http://vite.dev/guide/troubleshooting.html#module-externalized-for-browser-compatibility for more details.`);
	} }));
}) });
...
var require_pg_connection_string = /* @__PURE__ */ __commonJS({ "node_modules/pg-connection-string/index.js": ((exports, module) => {
	function parse$4(str, options = {}) {
		...
		const fs$1 = config.sslcert || config.sslkey || config.sslrootcert ? require_browser_external_fs() : null;
...
var require_connection_parameters = /* @__PURE__ */ __commonJS({ "node_modules/pg/lib/connection-parameters.js": ((exports, module) => {
	var dns = require_browser_external_dns();
	var defaults$3 = require_defaults();
	var parse$3 = require_pg_connection_string().parse;
...
var require_result = /* @__PURE__ */ __commonJS({ "node_modules/pg/lib/result.js": ((exports, module) => {
	var types$1 = require_pg_types();
...
var require_query$1 = /* @__PURE__ */ __commonJS({ "node_modules/pg/lib/query.js": ((exports, module) => {
	var { EventEmitter: EventEmitter$5 } = require_browser_external_events();
...
var require_serializer = /* @__PURE__ */ __commonJS({ "node_modules/pg-protocol/dist/serializer.js": ((exports) => {
	...
	var flushBuffer$1 = codeOnlyBuffer(72);
	var syncBuffer$1 = codeOnlyBuffer(83);
	var endBuffer$1 = codeOnlyBuffer(88);
...
var require_dist = /* @__PURE__ */ __commonJS({ "node_modules/pg-protocol/dist/index.js": ((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	...
	function parse$1(stream$1, callback) {
		const parser = new parser_1.Parser();
		stream$1.on("data", (buffer) => parser.parse(buffer, callback));
		return new Promise((resolve) => stream$1.on("end", () => resolve()));
	}
}) });

//#endregion
//#region browser-external:net
var require_browser_external_net = /* @__PURE__ */ __commonJS({ "browser-external:net": ((exports, module) => {
	module.exports = Object.create(new Proxy({}, { get(_, key) {
		if (key !== "__esModule" && key !== "__proto__" && key !== "constructor" && key !== "splice") console.warn(`Module "net" has been externalized for browser compatibility. Cannot access "net.${key}" in client code. See http://vite.dev/guide/troubleshooting.html#module-externalized-for-browser-compatibility for more details.`);
	} }));
}) });

//#endregion
//#region browser-external:tls
var require_browser_external_tls = /* @__PURE__ */ __commonJS({ "browser-external:tls": ((exports, module) => {
	module.exports = Object.create(new Proxy({}, { get(_, key) {
		if (key !== "__esModule" && key !== "__proto__" && key !== "constructor" && key !== "splice") console.warn(`Module "tls" has been externalized for browser compatibility. Cannot access "tls.${key}" in client code. See http://vite.dev/guide/troubleshooting.html#module-externalized-for-browser-compatibility for more details.`);
	} }));
}) });

//#endregion
//#region node_modules/pg-cloudflare/dist/empty.js
var require_empty = /* @__PURE__ */ __commonJS({ "node_modules/pg-cloudflare/dist/empty.js": ((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.default = {};
}) });
...
var require_stream = /* @__PURE__ */ __commonJS({ "node_modules/pg/lib/stream.js": ((exports, module) => {
	var { getStream: getStream$1, getSecureStream } = getStreamFuncs();
	module.exports = {
	...
	*/
	function getNodejsStreamFuncs() {
		...
		function getSecureStream$1(options) {
...
var require_connection = /* @__PURE__ */ __commonJS({ "node_modules/pg/lib/connection.js": ((exports, module) => {
	var EventEmitter$4 = require_browser_external_events().EventEmitter;
...
var require_browser_external_string_decoder = /* @__PURE__ */ __commonJS({ "browser-external:string_decoder": ((exports, module) => {
	module.exports = Object.create(new Proxy({}, { get(_, key) {
		if (key !== "__esModule" && key !== "__proto__" && key !== "constructor" && key !== "splice") console.warn(`Module "string_decoder" has been externalized for browser compatibility. Cannot access "string_decoder.${key}" in client code. See http://vite.dev/guide/troubleshooting.html#module-externalized-for-browser-compatibility for more details.`);
	} }));
}) });

//#endregion
//#region node_modules/split2/index.js
var require_split2 = /* @__PURE__ */ __commonJS({ "node_modules/split2/index.js": ((exports, module) => {
	...
	function split$1(matcher$1, mapper, options) {
		...
		const stream$1 = new Transform(options);
		stream$1[kLast] = "";
		stream$1[kDecoder] = new StringDecoder("utf8");
		stream$1.matcher = matcher$1;
		stream$1.mapper = mapper;
		stream$1.maxLength = options.maxLength;
		stream$1.skipOverflow = options.skipOverflow || false;
		stream$1.overflow = false;
...
var require_helper = /* @__PURE__ */ __commonJS({ "node_modules/pgpass/lib/helper.js": ((exports, module) => {
	var path = require_browser_external_path(), Stream = require_browser_external_stream().Stream, split = require_split2(), util$2 = require_browser_external_util(), defaultPort = 5432, isWin = process.platform === "win32", warnStream = process.stderr;
	...
	module.exports.warnTo = function(stream$1) {
		var old = warnStream;
		warnStream = stream$1;
		return old;
	};
	...
	module.exports.getPassword = function(connInfo, stream$1, cb) {
		var pass;
		var lineStream = stream$1.pipe(split());
...
var require_lib$1 = /* @__PURE__ */ __commonJS({ "node_modules/pgpass/lib/index.js": ((exports, module) => {
...
var require_client$1 = /* @__PURE__ */ __commonJS({ "node_modules/pg/lib/client.js": ((exports, module) => {
	var EventEmitter$3 = require_browser_external_events().EventEmitter;
	var utils$2 = require_utils$1();
	var nodeUtils$1 = require_browser_external_util();
	var sasl = require_sasl();
	var TypeOverrides$3 = require_type_overrides();
	var ConnectionParameters$1 = require_connection_parameters();
	var Query$1 = require_query$1();
	var defaults$2 = require_defaults();
	var Connection$2 = require_connection();
	...
	var queryQueueLengthDeprecationNotice$1 = nodeUtils$1.deprecate(() => {}, "Calling client.query() when the client is already executing a query is deprecated and will be removed in pg@9.0. Use async/await or an external async flow control mechanism instead.");
	...
	var Client$3 = class extends EventEmitter$3 {
		...
		query(config, values, callback) {
			...
			if (typeof config.submit === "function") {
				...
				else if (typeof query$1.callback !== "function") throw new TypeError("callback is not a function");
			}
			const readTimeout = config.query_timeout || this.connectionParameters.query_timeout;
			if (readTimeout) {
				const queryCallback = query$1.callback || (() => {});
...
var require_pg_pool = /* @__PURE__ */ __commonJS({ "node_modules/pg-pool/index.js": ((exports, module) => {
	var EventEmitter$2 = require_browser_external_events().EventEmitter;
	var NOOP = function() {};
...
var require_optional_peer_dep___vite_optional_peer_dep_pg_native_pg = /* @__PURE__ */ __commonJS({ "optional-peer-dep:__vite-optional-peer-dep:pg-native:pg": ((exports, module) => {
	module.exports = {};
...
var require_query = /* @__PURE__ */ __commonJS({ "node_modules/pg/lib/native/query.js": ((exports, module) => {
	var EventEmitter$1 = require_browser_external_events().EventEmitter;
	var util$1 = require_browser_external_util();
	var utils$1 = require_utils$1();
	var NativeQuery$1 = module.exports = function(config, values, callback) {
...
var require_client = /* @__PURE__ */ __commonJS({ "node_modules/pg/lib/native/client.js": ((exports, module) => {
	...
	var TypeOverrides$2 = require_type_overrides();
	...
	var Client$2 = module.exports = function(config) {
	...
	Client$2.prototype.getTransactionStatus = function() {
...
var require_native = /* @__PURE__ */ __commonJS({ "node_modules/pg/lib/native/index.js": ((exports, module) => {
	module.exports = require_client();
}) });

//#endregion
//#region node_modules/pg/lib/index.js
var require_lib = /* @__PURE__ */ __commonJS({ "node_modules/pg/lib/index.js": ((exports, module) => {
	var Client$1 = require_client$1();
	var defaults$1 = require_defaults();
	var Connection$1 = require_connection();
	var Result$1 = require_result();
	var utils = require_utils$1();
	var Pool$1 = require_pg_pool();
	var TypeOverrides$1 = require_type_overrides();
	var { DatabaseError: DatabaseError$1 } = require_dist();
	var { escapeIdentifier: escapeIdentifier$1, escapeLiteral: escapeLiteral$1 } = require_utils$1();
	var poolFactory = (Client$4) => {
	...
	var PG = function(clientConstructor$1) {
	...
	var clientConstructor = Client$1;
