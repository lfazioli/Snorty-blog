...
export default function Register() {
  ...
  return (
    <Layout>
      <Seo title="Registrazione" description="Crea un account su Snorty Blog." path="/register" noIndex />
      <div className="max-w-sm mx-auto py-8">
        ...
        <form onSubmit={handleRegister} className="rounded-lg border border-line bg-panel p-7 flex flex-col gap-4">
          ...
          <label className="flex flex-col text-sm text-dim">
            Confirm password
            <input type="password" autoComplete="new-password" minLength={8} value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} className={inputClass} required />
          </label>
