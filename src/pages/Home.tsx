  ...
  return (
    <Layout>
      ...
      <section className="text-white py-16 animate-fadeIn">
        <h1 className="text-4xl md:text-5xl font-bold mb-4 text-[#00ff99] animate-bounce">
          <TypeAnimation
            sequence={[
              "Welcome to my blog 👨‍💻",
              1500,
        ...
        <p className="opacity-90 max-w-2xl mb-8 animate-slideIn">
      ...
      <section className="text-white mb-14">
        <h2 className="text-2xl font-bold text-[#00ff99] mb-6 animate-fadeIn">What I Do</h2>

        <div className="grid md:grid-cols-3 gap-6">
          {/* Card 1 */}
          <div className="p-6 rounded-xl bg-[#00ff99]/10 border border-[#00ff99]/20 
                          hover:bg-[#00ff99]/20 hover:scale-105 hover:shadow-xl transition-transform duration-300
                          animate-slideInLeft"
               style={{ animationDelay: `0ms` }}>
            <svg className="w-10 h-10 mb-4 animate-spin-slow" fill="#00ff99" viewBox="0 0 24 24">
          ...
          <div className="p-6 rounded-xl bg-[#00ff99]/10 border border-[#00ff99]/20 
            ...
            <svg className="w-10 h-10 mb-4 animate-pulse" fill="#00ff99" viewBox="0 0 24 24">
      ...
      <section className="text-white">
        <h2 className="text-2xl font-bold text-[#00ff99] mb-6 animate-fadeIn">Latest Posts</h2>
